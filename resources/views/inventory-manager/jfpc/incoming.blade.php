    ...
    <div class="p-4 lg:p-10 bg-zinc-50  h-auto  rounded-lg border border-zinc-300">
        ...
        <dialog id="my_modal_6" class="modal  modal-bottom sm:modal-middle ">
            <div class="modal-box bg-zinc-50 border border-zinc-300 h-128">
                ...
                <form method="POST" action="{{ route('warehouse.jfpc.ship') }}">
                    @csrf
                ...
                '{{ strtolower($item->data_entry) }}'.includes(search.toLowerCase())"
                                        ...
                                        document.getElementById('incoming_id').value = '{{ $item->id }}';
                    ...
                    ">
                            ...
                            <input type="hidden" id="incoming_id" name="incoming_id">
            ...
            <div>
                <details class="dropdown ">
                    ...
                    <ul
                        ...
                        <li><label class="text-zinc-900"><input type="checkbox" onchange="toggleColumn('id', this)"
                                    checked> Line</label></li>
                        ...
                        <li><label class="text-zinc-900"><input type="checkbox"
                                    onchange="toggleColumn('class', this)">
                                Class</label></li>
                        ...
                        <li class="text-xs text-zinc-500 uppercase font-semibold px-1 flex justify-between">
                            Balance <input type="checkbox"
                                onchange="toggleSection(this, ['balance_head','balance_kilo'])" checked>
                        </li>
                        ...
                        <li><label class="text-zinc-900"><input type="checkbox"
                                ...
                                Head/Pack</label></li>
                        <li><label class="text-zinc-900"><input type="checkbox"
                                    onchange="toggleColumn('balance_kilo', this)" checked>Kilogram</label>
                        </li>
                        <hr class="my-2">
                        ...
                        <li><label class="text-zinc-900"><input type="checkbox"
                                    onchange="toggleColumn('left', this)">
                                Left</label></li>
                        <li><label class="text-zinc-900"><input type="checkbox"
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateRowData(rowData) {
            ...
            fetch(`/jfpc/incoming/${rowData.id}/update`, {
                    method: "POST",
                    headers: {
