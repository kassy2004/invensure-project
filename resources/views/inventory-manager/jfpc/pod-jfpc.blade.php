<div class="p-4 lg:p-10 bg-zinc-50  h-auto rounded-lg border border-zinc-300">
    ...
    <div class="mt-5">
        <div class="flex flex-col gap-5">
                                ...
                                <table class="min-w-full border border-zinc-300 rounded-lg overflow-hidden">
                                    ...
                                    <tbody class="text-sm">
                                        @php
                                            ...
                                            $outgoings = DB::table('jfpc_outgoing')
            ...
            @empty
                <div class="p-4 border rounded-lg border-zinc-300 text-center">
                    <p class="text-zinc-500">No PODs available.</p> 
                </div>
            @endforelse
